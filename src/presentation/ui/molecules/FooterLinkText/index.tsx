...
export const FooterLinkText: FC<FooterLinkTextProps> = ({ onPressLink, className = '' }) => {
  return (
    <View className={`flex-row justify-center items-center py-4 ${className}`}>
      <AppText className="text-white/60 font-outfit text-sm">
        ¿Ya tienes cuenta?{' '}
      </AppText>
      <Pressable onPress={onPressLink}>
        <AppText className="text-[#FF3E3D] font-outfit-bold text-sm">
          Iniciar Sesión
        </AppText>
      </Pressable>
    </View>
